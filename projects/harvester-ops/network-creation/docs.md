...
| <a name="input_ssh_username"></a> [ssh\_username](#input\_ssh\_username) | Specifies the username used for SSH authentication (Harvester nodes). Default is 'opensuse'. | `string` | `"opensuse"` | no |
