...
locals {
  ...
  instance_type = (
    local.harvester_node_count == 1 ? (local.harvester_cluster_size == "small" ? "g-16vcpu-64gb" : "g-32vcpu-128gb") :
    local.harvester_node_count == 3 ? (local.harvester_cluster_size == "small" ? "g-32vcpu-128gb" : "g-60vcpu-240gb") :
