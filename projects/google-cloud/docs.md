...
| <a name="requirement_rancher2"></a> [rancher2](#requirement\_rancher2) | 14.2.2 |
...
| <a name="provider_rancher2"></a> [rancher2](#provider\_rancher2) | 14.2.2 |
...
| [rancher2_cluster.rancher_cluster](https://registry.terraform.io/providers/rancher/rancher2/14.2.2/docs/resources/cluster) | resource |
...
| <a name="input_harvester_version"></a> [harvester\_version](#input\_harvester\_version) | Specifies the Harvester version. Default is 'v1.9.0'. | `string` | `"v1.9.0"` | no |
