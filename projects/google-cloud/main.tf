...
locals {
  ...
  instance_type = (
    local.harvester_node_count == 1 ? (local.harvester_cluster_size == "small" ? "n2-standard-16" : "n2-standard-32") :
    local.harvester_node_count == 3 ? (local.harvester_cluster_size == "small" ? "n2-standard-32" : "n2-standard-64") :
    "n2-standard-64"
  )
}
