...
variable "certified_os_image" {
  description = "Specifies whether to use the Harvester OS image released in the GitHub repository. If set to false, the default OpenSUSE image provided by the cloud provider will be used. Default is 'true'."
  type        = bool
  default     = true
}
