...
| Name | Type |
| ---- | ---- |
| [harvester_image.image](https://registry.terraform.io/providers/harvester/harvester/1.9.0/docs/resources/image) | resource |
...
| <a name="input_image_url"></a> [image\_url](#input\_image\_url) | Specifies the URL used to download the Harvester image. Default is 'https://download.opensuse.org/distribution/leap/16.0/appliances/openSUSE-Leap-16.0-Minimal-VM.x86_64-Cloud.qcow2'. | `string` | `"https://download.opensuse.org/distribution/openSUSE-current/appliances/Leap-16.0-Minimal-VM.x86_64-Cloud.qcow2"` | no |
